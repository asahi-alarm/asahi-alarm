...
if true; then
    ...
    export INSTALLER_BASE=https://github.com/asahi-alarm/asahi-alarm/releases/download/installer/
    export INSTALLER_DATA=https://github.com/asahi-alarm/asahi-alarm/releases/download/installer/installer_data.json
    export INSTALLER_DATA_ALT=https://alx.sh/installer_data.json
    export REPO_BASE=https://github.com/asahi-alarm/asahi-alarm/releases/download/installer/
